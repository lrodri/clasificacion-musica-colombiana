function [arch_no_png, arch_png_bonito]=graficar_cumb(archivo_sin_extension, tiempo, directorio)

% ---------------------------------------------------------------------------------------
% Esta funcion permite graficar las matrices de similitud para los generos musicales
% ingresados de la carpeta cumbia, sin extension, en el primer parametro de entrada 
...
arch_wav=['canciones/' directorio '/' archivo_sin_extension '.wav']
