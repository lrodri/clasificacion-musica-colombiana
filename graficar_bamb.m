function [arch_no_png, arch_png_bonito]=graficar_bamb(archivo_sin_extension, tiempo)

% ---------------------------------------------------------------------------------------
% Esta funcion permite graficar las matrices de similitud para los generos musicales
% ingresados de la carpeta bambuco, sin extension, en el primer parametro de entrada 
